...
public class HistoricoController {
    ...
    public ResponseEntity<List<HistoricoResponseDTO>> listarConcluidos(@PathVariable Long usuarioId) {
        return ResponseEntity.ok(historicoService.listarConcluidosPorUsuario(usuarioId));
    }
